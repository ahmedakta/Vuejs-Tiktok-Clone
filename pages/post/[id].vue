<template>
    ...
    >
        <div class="lg:w-[calc(100%-540px)] h-full relative">
            ...
            <img src="~/assets/images/tiktok-logo-small.png" class="absolute top-[18px] left-[70px] rounded-full lg:mx-0 mx-auto" width="45" alt="">
            <video v-if="true" class="absolute object-cover w-full my-auto z-[-1] h-screen" src="/post_video.mp4" />

            <div v-if="!isLoaded" class="flex items-center justify-center bg-black bg-opacity-70 h-screen lg:min-w-w[480px]">
                <Icon class="animate-spin ml-1" name="mingcute:loading-line" size="100" color="#FFFFFF" />
            </div>

            <div class="bg-black bg-opacity-70 lg:min-w-[480px]">
                <video v-if="true" ref="video" loop muted class="h-screen mx-auto" src="/post_video.mp4" />
            </div>
        </div>
        ...
        <div id="InfoSection" v-if="true" class="lg:max-w-[550px] relative w-full h-full bg-white">
            ...
            <div class="flex items-center justify-between px-8">
                <div class="flex items-center">
                    <NuxtLink href="/">
                        <img src="https://picsum.photos/id/8/300/320" width="40" class="rounded-full lg:mx-0 mx-auto " alt="">
                    </NuxtLink>
            ...
            <div class="flex items-center px-8 mt-8">
                <div class="pb-4 text-center flex items-center">
                    ...
                    <span class="text-sm pl-2 pr-4 text-gray-800 font-semibold">2</span>
                </div>
                ...
                <div v-else class="flex items-center justify-between px-8 mt-4">
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            ...
                            <div class="text-[15px] text-light">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Explicabo, magni non voluptatum dolorum tempore adipisci soluta inventore, rem facilis, exercitationem eligendi minus voluptatem assumenda natus. Architecto vero quia quo distinctio.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="CreateComment" v-if="true" class="absolute flex items-center justify-between bottom-0 bg-white h-[85px] lg:max-w-[550px] w-full py-5 px-8 border-t-2">
                ...
                >
                   <input type="text" placeholder="Add Comment .." v-model="comment" @focus="$event => inputFocused = true" @blur="$event => inputFocused  = false" class="bg-[#F1F1F2] text-[14px] focus:outline-none w-full lg:max-w-[420px] p-2 rounded-lg"> 
                </div>

                <button :disabled="!comment" @click="$event => addComment()" :class="comment ? 'text-[#F02C56] cursor-pointer' : 'text-gray-400'" class="font-semibold text-sm ml-5 pr-1">Post</button>
            </div>
        </div>
    </div>
</template> 
