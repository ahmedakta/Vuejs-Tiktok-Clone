    ...
    <MainLayout>
            <div class="pt-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 pr-2 w-[calc(100%-90px)] max-w-[1800px] 2xl:mx-auto">
                <div class="flex w-[calc(100vw-230px)]">
                    <img src="https://picsum.photos/id/8/300/320" class="max-w-[120px] rounded-full" alt="">
                ...
                <!-- Bio Section -->
                <div class="pt-4 mr-4 text-gray-500 font-light test-[15px] pl-1.5 max-w-[500px]">This is the bio section</div>
                
                <div class="w-full flex items-center pt-4 border-b">
                    <div class="w-60 text-center py-2 text-[17px] font-smibold border-b-2 borrder-b-black">Videos</div>
                    <div class="w-60 text-gray-500 tex-center py-2 text-[17px] font-semibold">
